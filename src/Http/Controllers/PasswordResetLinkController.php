...
use Deudev\Authify\Contracts\FailedPasswordResetLinkRequestResponse;
use Deudev\Authify\Contracts\RequestPasswordResetLinkViewResponse;
use Deudev\Authify\Contracts\SuccessfulPasswordResetLinkRequestResponse;
...
class PasswordResetLinkController extends Controller
{
     ...
     * @return \Deudev\Authify\Contracts\RequestPasswordResetLinkViewResponse
     */
    ...
    {
        $request->validate([Authify::email() => 'required|email']);

        // We will send the password reset link to this user. Once we have attempted
        // to send the link, we will examine the response then see the message we
        // need to show to the user. Finally, we'll send out a proper response.
        $status = $this->broker()->sendResetLink(
            $request->only(Authify::email())
        );
